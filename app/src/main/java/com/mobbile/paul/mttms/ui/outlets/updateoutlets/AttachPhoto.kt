...
class AttachPhoto : BaseActivity(), View.OnClickListener {
            ...
            when (values) {
                ...
                3 -> {
                    if (!postPath.isNullOrBlank()) {
                        ...
                        vmodel.updateCards(
                            tmid!!, urno!!, outletClass!!, prefLang!!, outletTypeId!!, custName!!, address!!, contactName!!, phones!!, lat!!, lng!!,
    ...
    private val ObserveImage = Observer<String> {
        ...
        if(it=="OK") {
            showMsgDialog(Customers(), this, "Successful", "Customer Updated successfully")
        }else{
            showSomeDialog(this, "Fail to update, please contact MT monitor", "Update Error")
        }
    }
